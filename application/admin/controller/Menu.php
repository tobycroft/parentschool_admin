...
class Menu extends Admin
{
    ...
    public function add($module = 'admin', $pid = '')
    {
        ...
        return ZBuilder::make('form')
            ...
            ->addCheckbox('child_node', '子节点', '仅上面选项为【是】时起作用', ['add' => '新增', 'edit' => '编辑', 'delete' => '删除', 'enable' => '启用', 'disable' => '禁用', 'quickedit' => '快速编辑', 'export' => '导出'], 'add,edit,delete,enable,disable,quickedit,export')
