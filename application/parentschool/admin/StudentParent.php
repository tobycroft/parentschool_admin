 ...
 */
class StudentParent extends Admin
{
    /**
     * 用户首页
     * @return mixed
    ...
    public function index()
    {
        ...
        $data_list = FamilyMemberModel::field("a.*")->alias("a")->leftJoin(["ps_user" => "b"], "a.uid=b.id")->leftJoin(["ps_student" => "c"], "a.student_id=c.id")->where($map)->order($order)->paginate();
