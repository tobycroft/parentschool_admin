    ...
    public function add()
    {
        ...
        return ZBuilder::make('form')
            ...
            ->addFormItems([ // 批量添加表单项
                ...
                ['number', 'score7', '加权7', '正确答案设定为1，不正确设定为0，如果需要使用加权评价算法，设定大于1即可',],
                ['text', 'select8', '选项8', '需要显示就填写，留空则不会在界面中显示本选项',],
                ['number', 'score8', '加权8', '正确答案设定为1，不正确设定为0，如果需要使用加权评价算法，设定大于1即可',],
                ['text', 'select9', '选项9', '需要显示就填写，留空则不会在界面中显示本选项',],
                ['number', 'score9', '加权9', '正确答案设定为1，不正确设定为0，如果需要使用加权评价算法，设定大于1即可',],
            ])
